    ...
    <section id="reviews" className="section border-t border-hairline/50" aria-labelledby="reviews-heading">
      <div className="shell-wide grid gap-14 lg:grid-cols-12 lg:gap-16">
        ...
        <div className="lg:col-span-4 lg:sticky lg:top-28 lg:self-start">
          ...
          <h2 id="reviews-heading" className="mt-7 font-display text-4xl font-normal">
            What it does
            <br />
            on skin.
          </h2>
          ...
          {data.count > 0 ? (
            <div className="mt-10">
              <div className="flex items-baseline gap-4">
                <p className="font-display text-6xl font-normal tabular-nums text-accent">
                  {data.average?.toFixed(1)}
                </p>
                <div>
                  <Rating value={data.average || 0} />
                  <p className="mt-2 font-mono text-[12px] uppercase tracking-[0.07em] text-ink-4">
            ...
            <p className="mt-10 max-w-[32ch] text-[16px] leading-relaxed text-ink-3">
        ...
        <div className="lg:col-span-7 lg:col-start-6">
          ...
          {loading ? (
            ...
            <p className="border-t border-hairline/50 pt-10 font-display text-xl font-normal text-ink-3">
            ...
            <ul className="divide-y divide-hairline/40 border-t border-hairline/50">
              {data.reviews.map((review, i) => (
                ...
                >
                  ...
                  {review.title && (
                    <h3 className="mt-5 font-display text-2xl font-normal">{review.title}</h3>
                  )}
                  ...
                  <p className="mt-6 flex flex-wrap items-center gap-3 font-mono text-[12px] uppercase tracking-[0.07em] text-ink-4">
  ...
  if (state === 'done') {
    return (
      <div className="mb-12 border border-[var(--accent)]/40 bg-surface p-8">
        <p className="font-display text-2xl font-normal text-accent">Thank you.</p>
  ...
  return (
    <form onSubmit={onSubmit} className="mb-14 border border-hairline/60 bg-surface p-8">
      ...
      <fieldset className="mt-7">
        <legend className="font-mono text-[12px] uppercase tracking-[0.08em] text-ink-4">
          Rating
        </legend>
      ...
      {message && state === 'error' && (
        <p className="mt-5 font-mono text-[13px] uppercase tracking-[0.07em] text-red-400">
          {message}
        </p>
      )}
      ...
      <div className="mt-9 flex flex-wrap items-center gap-6">
        ...
        <p className="max-w-[34ch] text-[14px] leading-relaxed text-ink-4">
