      ...
      <div className="shell-wide grid grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-10">
        ...
        <div className="lg:col-span-5 lg:sticky lg:top-32 lg:self-start">
          ...
          >
            ...
            <div className="mt-5 flex items-baseline justify-between">
              ...
              <p className="font-mono text-[9px] tabular-nums text-ink-4">01</p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="lg:col-span-6 lg:col-start-7">
          ...
          <div className="mt-16 grid gap-10 sm:grid-cols-3">
            {HOUSE_STORY.columns.map((col, i) => (
              ...
              >
                ...
                <h3 className="font-mono text-[10px] uppercase tracking-[0.24em] text-ink">
                  {col.heading}
                </h3>
          ...
          >
            ...
            <footer className="mt-5 font-mono text-[10px] uppercase tracking-[0.24em] text-ink-4">
          ...
          <div className="grid grid-cols-3 gap-6 border-y border-hairline/50 py-10">
            {FIGURES.map((fig) => (
              <div key={fig.label}>
                ...
                <p className="mt-3 font-mono text-[9px] uppercase leading-relaxed tracking-[0.2em] text-ink-4">
                  {fig.label}
                </p>
              </div>
            ))}
          ...
          <Cursorable variant="link">
            <Link href="/about" className="link-draw mt-12 inline-block font-mono text-[11px] uppercase tracking-[0.24em] text-accent">
