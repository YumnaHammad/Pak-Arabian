...
export const CATEGORIES = [
  ...
  { label: 'For Him', value: 'men', blurb: 'Structured, resinous, deliberate.' },
  { label: 'For Her', value: 'women', blurb: 'Luminous florals with a shadowed base.' },
...
export const HOUSE_STORY = {
  ...
  lede:
    'Azwah began in a single room in Sadiqabad with a set of brass funnels, a maceration cabinet, and a conviction that the East had been supplying the world’s great houses with raw material for centuries without ever signing its own name to the bottle.',
  columns: [
    {
      heading: 'Origin',
      body:
...
export const FAQ_GROUPS = [
  {
    ...
    items: [
      {
        q: 'How long will an Azwah fragrance last on skin?',
